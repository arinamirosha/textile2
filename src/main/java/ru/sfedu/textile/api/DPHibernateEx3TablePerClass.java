...
import ru.sfedu.textile.classes.ex3tablePerClass.TextileProduct;
...
import static ru.sfedu.textile.constants.Constants.NOT_ADDED;

public class DPHibernateEx3TablePerClass implements IDPHibernateEx3 {

    private static Logger log = LogManager.getLogger(DPHibernateEx3TablePerClass.class);
    private Session openSession() {
        return HibernateUtil.getSessionFactory(SCHEMA_EX3_TABLE_PER_CLASS).openSession();
    }
