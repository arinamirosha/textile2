...
import ru.sfedu.textile.classes.ex3singleTable.Bedding;
import ru.sfedu.textile.classes.ex3singleTable.Clothes;
import ru.sfedu.textile.classes.ex3singleTable.Document;
import ru.sfedu.textile.classes.ex3singleTable.TextileProduct;
...
public class DPHibernateEx3SingleTable implements IDPHibernateEx3 {

    private static Logger log = LogManager.getLogger(DPHibernateEx3SingleTable.class);
    private Session openSession() {
        return HibernateUtil.getSessionFactory(SCHEMA_EX3_SINGLE_TABLE).openSession();
    }
